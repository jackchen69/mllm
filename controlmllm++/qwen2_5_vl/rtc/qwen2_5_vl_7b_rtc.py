...
def parse_args():
    ...
    p.add_argument('--data_path',  default="dataset/COCO-Text")
    p.add_argument('--question_file', default='dataset/COCO-Text/question_rtc.json')
    p.add_argument('--set', type=str, default='test', choices=['test', 'val'], help="Use test or validation split")
    p.add_argument('--answers_file',  default='outputs/qwen2_5_vl_7b_rtc.json')
